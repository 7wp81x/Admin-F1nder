...
try:
    ...
    print("Module Named 'os' not found, Kindly install it by typing 'python -m pip install os -y' on your terminal")
    exit()
...
\n""")
    ...
    print(Fore.GREEN + "Join Our Group:" + Fore.RED + " Android Hacker PH (https://web.facebook.com/groups/1778790372291663)\n\n")

    web = input(Fore.BLUE + 'URL: ')
    file = open('admin_wordlist.txt', 'r+')
